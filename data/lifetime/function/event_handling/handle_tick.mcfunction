...
## Limit enchants on weapons and tools for players every 10 ticks
scoreboard players add $enchant_limiter_cooldown temp 1
execute if score $enchant_limiter_cooldown temp matches 10.. run function lifetime:enchantment/tick
execute if score $enchant_limiter_cooldown temp matches 10.. run scoreboard players set $enchant_limiter_cooldown temp 0