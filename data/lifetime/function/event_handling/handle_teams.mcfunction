...
execute if score bballty115 TimeHours matches ..-1 run execute if score bballty115 ActivePlayer matches 1 run title @a title [{"text": "bballty115 timed out", "color": "red"}]
